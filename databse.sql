...
INSERT INTO users VALUES('1', 'paola.pappalardo@outlook.it','Paolapappalardo1@','Paola','Pappalardo');

SELECT * FROM users;
SELECT * FROM reset_password;


INSERT INTO exibitions (content) VALUES ('{"image" : "images/section_s1.webp" , "title" : "An-My Le" , "text" : "Member Last Look, Mar17 Last chance Through Mar16", "image_dinamic" : "images/s1_js.jpg"}');
INSERT INTO exibitions (content) VALUES ('{"image" : "images/section_s2.jpg" , "title" : "Crafting Modernity: Design in Latin America, 1940-1980" , "text" : "Through Sep 22", "image_dinamic" : "images/s2_js.jpg"}');
INSERT INTO exibitions (content) VALUES ('{"image" : "images/section_s3.jpg" , "title" : "Joan Jonas: Good Night Good Morning" , "text" : "Member Previews, Mar14-16 Mar17-Jul6, 2024", "image_dinamic" : "images/s3_js.jpg"}');
INSERT INTO exibitions (content) VALUES ('{"image" : "images/section_s4.jpg" , "title" : "Shana Moulton: Meta/Physical Therapy" , "text" : "Through Apr 21", "image_dinamic" : "images/s4_js.jpg"}');
INSERT INTO exibitions (content) VALUES ('{"image" : "images/section_s5.jpg" , "title" : "Grace Wales Bonner" , "text" : "Now on view", "image_dinamic" : "images/s5_js.avif"}');
INSERT INTO exibitions (content) VALUES ('{"image" : "images/section_s6.jpg" , "title" : "Body Constructs" , "text" : "What happens when design collides with real people?", "image_dinamic" : "images/s6_js.jpg"}');
INSERT INTO exibitions (content) VALUES ('{"image" : "images/section_s7.jpg" , "title" : "Read, watch, and listen from wherever you are." , "text" : "Explore Magazine Online", "image_dinamic" : "images/s7_js.jpg"}');
INSERT INTO exibitions (content) VALUES ('{"image" : "images/section_s8.jpg" , "title" : "Visit MoMA PS1 in Queens" , "text" : "Free for New Yorkers MoMA PS1", "image_dinamic" : "images/s8_js.webp"}');

SELECT * from exibitions;

INSERT INTO magazine (content) VALUES('{"image" : "images/magazine2.jpg", "title1": "Drawn to MoMA", "title2" : "Kristen Radtke’s Pregnancy in Art", "description" : "The illustrator reflects on her journey to motherhood and how it changed her relationship to art.", "author_and_date" : "Kristen Radtke May 8, 2024"}');
INSERT INTO magazine (content) VALUES('{"image" : "images/magazine.jpeg", "title1": "Drawn to MoMA", "title2" : "Manjit Thapp Thaw Out", "description" : "The illustrator helps us look beyound our winter blues.", "author_and_date" : "Manjit Thapp Mar13, 2024"}');

SELECT * from magazine;

INSERT INTO collection (category, content) VALUES ('Painting and Sculpture', '{"image" : "images/collection1.jpg" , "author" : "Piet Mondrian" , "name" : "Composition with Red, Blue, Black, Yellow, and Gray" , "period" : "1921" , "location" : "MoMA, Floor 5, 513" , "credit" : "Gift of John L. Senior, Jr." , "dimension" : "29 7/8 x 20 5/8 (76 x 52.4 cm)" , "description" : "Oil on canvas" }');
...
INSERT INTO collection (category, content) VALUES ('Drawings and Prints', '{"image" : "images/collection10.jpg" , "author" : "Brice Marden" , "name" : "Drawing 2 Hydra" , "period" : "1986" , "location" : "MoMA, Floor 4, 407" , "credit" : "Gift of Mr. & Mrs. Maxime L. Hermanos (by exchange)" , "dimension" : "19 1/2 x 15 1/8 (49.5 x 38.5 cm)" , "description" : "Gouache and ink on paper" }');
INSERT INTO collection (category, content) VALUES ('Drawings and Prints', '{"image" : "images/collection11.jpg" , "author" : "Ellsworth Kelly" , "name" : "Study for Meschers" , "period" : "1951" , "location" : "MoMA, Floor 4, 416" , "credit" : "Gift of the artist" , "dimension" : "19 1/2 x 19 1/2 (49.5 x 49.5 cm)" , "description" : "Cut-and-pasted printed paper" }');

INSERT INTO sponsor (content) VALUES ('{"image" : "images/sponsor1.jpg"}');
INSERT INTO sponsor (content) VALUES ('{"image" : "images/sponsor2.jpg"}');
INSERT INTO sponsor (content) VALUES ('{"image" : "images/sponsor3.jpg"}');
INSERT INTO sponsor (content) VALUES ('{"image" : "images/sponsor4.jpg"}');
...
INSERT INTO favorites (id_user, id_collection, time) VALUES (2, 3, current_date());
...
SELECT c.* FROM (favorites f JOIN users u ON f.id_user=u.id) JOIN collection c on c.id=f.id_collection WHERE id_user=1;
